...
if command -v cmake >/dev/null 2>&1; then
    ...
    echo "install CMake, the MSVC C++ build tools, and Python 3 with PyYAML (e.g. winget install the Kitware CMake package, plus VS Build Tools, plus 'py -m pip install pyyaml')" >&2
    exit 1
fi
