...
libyeast parses untrusted, potentially hostile input, and serves as a building block for sensitive software.
...
- **Otherwise:** [email the maintainer](mailto:libyeast-oren@ben-kiki.org) with details, and a reproducer where you have
  any.
